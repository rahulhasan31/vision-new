      ...
      <div class="max-w-7xl mx-auto">
        <div class="pb-10 mb-10 border-b border-gray-700 items-center ">
          <div class="flex flex-wrap -mx-4 items-center">
            <div class="w-full lg:w-32 px-4 mb-4 lg:mb-0">
              <a class="inline-block" href="#">
                <img class="w-15 h-15 " src="https://i.ibb.co/gtMSy6N/VTL-Logo-removebg-preview.png" alt="">
              </a>
            </div>
        ...
        <div class="sm:flex items-center justify-between">
          ...
          <div class="flex items-center">
            ...
            <a class="inline-block p-1 hover:bg-gray-800 rounded-md" href="#">
              <img class="text-white" src="saturn-assets/images/footers/outline-linkedin.svg" alt="">
            </a>
          </div>
        </div>
      </div>
